...
Thanks for using staticdatagen. Here is where to go for each kind of help.

## Questions & how-to

- **[Discussions](https://github.com/sebastienrousseau/staticdatagen/discussions)**
...
- **Docs** — [`README.md`](README.md), [`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md),
  ...
  [docs.rs/staticdatagen](https://docs.rs/staticdatagen).
...
staticdatagen is maintained by a small team (currently one person) on a
