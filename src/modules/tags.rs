...
/// Sanitize tag to remove special characters.
///
/// # Arguments
///
/// * `tag` - A reference to the tag string to be sanitized.
///
/// # Returns
///
/// A sanitized tag string with special characters removed.
///
...
/// use staticdatagen::modules::tags::generate_tags;
...
/// ```rust
/// use std::collections::HashMap;
/// use staticdatagen::modules::tags::create_tags_data;
///
/// let mut metadata = HashMap::new();
...
/// use staticdatagen::modules::tags::generate_tags_html;
///
...
/// # Returns
///
/// Returns an `io::Result<()>` which is `Ok` if the operation was successful.
...
/// ```rust
/// use std::path::Path;
/// use staticdatagen::modules::tags::write_tags_html_to_file;
///
